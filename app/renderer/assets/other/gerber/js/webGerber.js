...
//    var has3D = true;
//    try {
//      wG.renderer = THR51.WebGLRenderer({
//        antialias: true
//      });
//      //wG.constants.ppmm = 20;
//      wG.renderer.sortObjects = false;
...
//      has3D = false;
//      wG.constants.ppmm = 20;
//      wG.renderer = THR51.CanvasRenderer({
//        antialias: true
//      });
//    }
//
...
//        ambient: 0xaaaaaa,
//        specular: 0xcccccc,
//        map: wG.boards.top.texture
//      }),
//      new Material({
//        shininess: 80,
//        ambient: 0xaaaaaa,
//        specular: 0xcccccc,
//        map: wG.boards.bottom.texture
//      }),
//      null,
//      null
//    ];
...
//      materials[2].overdraw = true, materials[3].overdraw = true;
//    }
//    wG.board = THR51.Mesh(THR51.CubeGeometry(wG.boards.width, wG.constants.geometry.boardThickness, wG.boards.height, has3D ? 1 : Math.ceil(wG.boards.width / 3), 1, has3D ? 1 : Math.ceil(wG.boards.height / 3), materials, {
//      px: 0,
//      nx: 0,
//      pz: 0,
//      nz: 0
//    }), THR51.MeshFaceMaterial());
//    wG.board.position.y = -100;
//
//    if (has3D) {
//      wG.scene.add(wG.board);
...
//
//    // Add the sides.
//    var boardSides = THR51.CubeGeometry(wG.boards.width, wG.constants.geometry.boardThickness, wG.boards.height, 1, 1, 1, undefined, {
//      py: 0,
//      ny: 0
//    });
//    var boardMaterial = new Material(wG.constants.materials.board);
