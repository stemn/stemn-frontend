...
export default class extends React.Component{
  ...
  render() {
//    return <iframe src="assets/js/pdf/web/viewer-stemn.html?file=" frameborder="0"></iframe>
    return (
      <div>pdf</div>
    )
    ...
    <div id="outerContainer">
        ...
        <div id="mainContainer">
            ...
            <div class="toolbar-top">
                <a id="sidebarToggle" class="st-toolbarButton" title="Toggle Sidebar" tabindex="11" data-l10n-id="toggle_sidebar">
                </a>
            </div>
                ...
                <div id="toolbarContainer">
                    <div id="toolbarViewer">
                        ...
                        <div id="toolbarViewerRight">
                            ...
                            <div class="hidden verticalToolbarSeparator hiddenSmallView"></div>
